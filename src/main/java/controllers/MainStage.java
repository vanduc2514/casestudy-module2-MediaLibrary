...
import model.*;
import service.facade.FacadeUtil;
import service.facade.LibraryUtil;
import controllers.sorter.Sorter;
import controllers.sorter.SorterUseComparator;
...
public class MainStage implements Initializable {
    ...
    @FXML
    public void exportToText(ActionEvent actionEvent) {
        FileChooser.ExtensionFilter extensionFilter = new FileChooser.ExtensionFilter("File Txt", "*.txt");
        fileChooser.getExtensionFilters().add(extensionFilter);
        File file = fileChooser.showSaveDialog(new Stage());
        facadeUtil.exportToText(file);
    }
